...
mod tests {
    use super::*;
    use deskward_core::checklist::{required_checks, CheckId, CheckStatus, Platform};
    use deskward_core::role::DeviceRole;

    #[test]
    fn incomplete_snapshot_blocks() {
        ...
        snap.set(CheckId::ScreenRecording, CheckStatus::Pending);
